...
export default function FormEdit({route}) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setNamaLengkap(json.namalengkap2010054);
        setJenisKelamin(json.jenkel2010054);
        setTempatLahir(json.tmp_lahir2010054);
        setTanggalLahir(new Date(json.tgl_lahir2010054));
        setAlamat(json.alamat2010054);
        setNoTelp(json.notelp2010054);
      } catch (error) {
  ...
  const submitForm = async () => {
    ...
    const formData = {
      namalengkap2010054: namaLengkap,
      jenkel2010054: jenisKelamin,
      tmp_lahir2010054: tempatLahir,
      tgl_lahir2010054: tanggalLahir.toISOString().split('T')[0], // Format to YYYY-MM-DD
      alamat2010054: alamat_2010054,
      notelp2010054: noTelp,
      _method: 'PUT',
    };
      ...
      Alert.alert('Success', 'Data dosen ini berhasil di-Update', [
        {
          text: 'Ok',
          onPress: () =>
            navigation.navigate('DetailDosen', {nidn2010054: nidn2010054}),
        },
      ]);
    } catch (error) {
      // Handle failure
  ...
  return (
    <ScrollView
      ...
      <Input
        ...
        errorMessage={validationErrors.namalengkap2010054}
      />
      ...
      <Input
        ...
        inputContainerStyle={styles.inputContainer}
        inputStyle={styles.inputText}
        errorMessage={validationErrors.tmp_lahir2010054}
      />
      ...
      <Input
        ...
        inputContainerStyle={styles.inputContainer}
        inputStyle={styles.inputText}
        errorMessage={validationErrors.alamat2010054}
      />
      ...
      <Input
        ...
        inputContainerStyle={styles.inputContainer}
        inputStyle={styles.inputText}
        errorMessage={validationErrors.notelp2010054}
