...
export default function Dosen() {
  ...
  const renderItemDosen = ({item}) => {
    const showDetailDosen = () => {
      navigation.navigate('DetailDosen', {nidn2010054: item.nidn2010054});
    };
    return (
      <TouchableOpacity style={styles.item} onPress={showDetailDosen}>
        <Text style={styles.titleNidn}>{item.nidn2010054}</Text>
        <Text style={styles.text}>{item.namalengkap2010054}</Text>
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        keyExtractor={item => item.nidn2010054}
