  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log(`${kdmatkul2010054}`);
        const response = await fetch(`${apiUrl}matakuliah/${kdmatkul2010054}`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
        const json = await response.json();
        setNamaMatkul(json.namamat2010054);
        setsKs(json.sks2010054);
      } catch (error) {
  ...
  return (
    <ScrollView
      ...
      <Input
        ...
        errorMessage={validationErrors.namamat2010054}
      />
      <Input
        placeholder="SKS"
        value={sKs}
        ...
        inputContainerStyle={styles.inputContainer}
        inputStyle={styles.inputText}
        errorMessage={validationErrors.sks2010054}
